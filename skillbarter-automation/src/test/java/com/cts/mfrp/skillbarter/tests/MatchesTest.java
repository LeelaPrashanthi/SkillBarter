...
public class MatchesTest extends BaseTest {
    ...
    @Test(testName = "TC_056", description = "Find New Matches tab is visible on Matches page after sign in",
...
//                "'Find New Matches' tab should be visible on the Matches page");
        ...
        Assert.assertTrue(matchesPage.waitForUserCardsToLoad(),
                "Expected at least one user card on Find New Matches within 35 seconds");
    ...
    public void tc058_searchFiltersByTerm(int rowIndex, String term) {
        ...
        try {
            ...
            Assert.assertTrue(matchesPage.waitForUserCardsToLoad(),
                    "Expected the user grid to load before searching for '" + term + "'");
...
//     Result is written back to xlsx.
    ...
    public void tc064_connectButtonSendsRequest() {
        ...
        Assert.assertTrue(matchesPage.waitForUserCardsToLoad(),
                "Need at least one suggested match to click Connect");
    ...
    public void tc065_connectReflectsInMyMatchesAndDisablesConnect() {
        ...
        Assert.assertTrue(matchesPage.waitForUserCardsToLoad(),
                "Expected user cards on Find New Matches within 35 seconds");
